...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 font-sans relative overflow-hidden p-6">
      ...
      <div 
        className="absolute inset-0 bg-cover bg-center opacity-25 pointer-events-none scale-105 filter blur-[2px]"
        style={{ backgroundImage: `url(${authBg})` }}
      />
      <div className="absolute inset-0 bg-slate-950/70 backdrop-blur-[8px] pointer-events-none" />

      {/* Decorative ambient radial glows using brand colors */}
      ...
      <div className="w-full max-w-md animate-fade-in-up relative z-10">
        <Card className="p-8 lg:p-10 border border-slate-800/80 rounded-2xl bg-slate-900/85 backdrop-blur-xl shadow-2xl shadow-slate-950/60 relative overflow-hidden group">
          {/* Top decorative corporate brand gradient line */}
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center mb-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 text-[10px] font-bold rounded-full bg-primary/20 text-sky-400 border border-primary/30 tracking-wider uppercase">
                <ShieldCheck className="h-3.5 w-3.5 animate-pulse text-sky-400" />
              </span>
            </div>
          ...
          <form onSubmit={onSignIn} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="ai-email" className="text-xs font-bold uppercase tracking-wider text-slate-400">
                Admin Email
              </Label>
              <Input 
                id="ai-email" 
                ...
                className="h-12 rounded-xl bg-slate-950 border-slate-800 focus-visible:ring-primary focus-visible:border-primary text-base font-semibold px-4 transition-all focus:scale-[1.01] text-white placeholder:text-slate-600" 
              />
            </div>

            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Label htmlFor="ai-pw" className="text-xs font-bold uppercase tracking-wider text-slate-400">
                  Password
                </Label>
              </div>
              <div className="relative">
                <Input 
                  ...
                  className="h-12 rounded-xl bg-slate-950 border-slate-800 focus-visible:ring-primary focus-visible:border-primary text-base font-semibold pl-4 pr-12 transition-all focus:scale-[1.01] text-white placeholder:text-slate-600" 
                />
                <button 
                  type="button" 
